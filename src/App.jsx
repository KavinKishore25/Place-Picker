...
function App() {
  ...
  const places = storedPlaces.map(id => AVAILABLE_PLACES.find((place) => place.id === id));
  ...
  const handleRemovePlace = useCallback(function handleRemovePlace() {
    ...
    const storedPlaces = JSON.parse(localStorage.getItem('selectedPlaces')) || [];
    localStorage.setItem('selectedPlaces', JSON.stringify(storedPlaces.filter(id => id !== selectedPlace.current)))
  }, [])
